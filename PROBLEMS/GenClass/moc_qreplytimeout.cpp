/****************************************************************************
** Meta object code from reading C++ file 'qreplytimeout.h'
**
...
#error "The header file 'qreplytimeout.h' doesn't include <QObject>."
...
void QReplyTimeout::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QReplyTimeout *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject QReplyTimeout::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_QReplyTimeout.data,
    qt_meta_data_QReplyTimeout,
    qt_static_metacall,
    nullptr,
    nullptr
} };
