...
class KMeans {
 public:
  ...
  bool getNewSamples(const std::vector<Point> &points);
  // Run until convergence.
  bool run();

  // Load the points from file and into the vector.
  static bool loadPoints(const std::string &filepath, std::vector<Point> *points);
 ...
 protected:
  ...
  void computeClusterMean(const std::multimap<int, const Point *> &multimap, int cluster, Point *mean);
