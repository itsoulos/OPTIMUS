...
then
	...
	if qmake -v > /dev/null
	then
		methods=("Optimus" "islandDE" "islandMultistart" "Bfgs" "IntegerGenetic" "Genetic" "DoubleGenetic" "MinCenter" "Tmlsl" "GENDE" "GCRS" "DE" "Price" "Multistart" "Pso" "iPso"  "Minfinder" "NeuralMinimizer" "ParallelDe" "parallelPso" "ParallelGenetic" "pDoubleGenetic" "pdg" )
