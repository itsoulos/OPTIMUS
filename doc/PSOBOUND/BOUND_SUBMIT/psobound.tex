...
error for all datasets. Also, the column CLASSES in Table \ref{tab:exp1}
denotes the number of classes for every dataset. All the experiments
were conducted on AMD Epyc 7552 equipped with 32GB of RAM. The operating
system was the Ubuntu 20.04 operating system. For the conducted experiments
the Optimus programming library available from \url{https://github.com/itsoulos/OPTIMUS}
was used.
