...
error for the associated datasets. All the experiments were conducted
on AMD Epyc 7552 equipped with 32GB of RAM. The operating system was
the Ubuntu 20.04 operating system. For the conducted experiments the
Optimus programming library available from \url{https://github.com/itsoulos/OPTIMUS}(accessed
...
even if the Adam method is used as a local minimization method. 
