...
than encouraging. For the conducted experiments, the Optimus programming
library available from \url{https://github.com/itsoulos/OPTIMUS}(accessed
...
on 4 April 2023) was used. For the regression datasets the range of
targets for every dataset is shown in Table \ref{tab:Range-of-targets}.
...
\caption{Range of targets for regression datasets.\label{tab:Range-of-targets}}

\centering{}%
\begin{tabular}{|c|c|}
\hline 
DATASET & RANGE\tabularnewline
\hline 
\hline 
ABALONE & 19.0\tabularnewline
\hline 
AIRFOIL & 0.41\tabularnewline
\hline 
BASEBALL & 42.50\tabularnewline
\hline 
BK & 0.32\tabularnewline
\hline 
BL & 0.68\tabularnewline
\hline 
CONCRETE & 0.77\tabularnewline
\hline 
DEE & 4.12\tabularnewline
\hline 
DIABETES & 0.90\tabularnewline
\hline 
HOUSING & 43.0\tabularnewline
\hline 
FA & 0.51\tabularnewline
\hline 
MB & 0.10\tabularnewline
\hline 
MORTGAGE & 12.74\tabularnewline
\hline 
PY & 0.84\tabularnewline
\hline 
QUAKE & 0.60\tabularnewline
\hline 
TREASURY & 15.54\tabularnewline
\hline 
WANKARA & 0.605\tabularnewline
\hline 
\end{tabular}
\end{table}
...
and the Adam local optimization methods during the second phase. The
numbers in tables represent average classification error as measured
in the test set for every dataset.\label{tab:exp1Adam}}
...
the Adam local optimization methods during the second phase. The numbers
in tables represent average regression error as measured in the test
set for every dataset.\label{tab:exp2Adam}}
