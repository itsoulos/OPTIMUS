...
For the current algorithm the points $x_{i}$ are randomly selected
samples in $S$.
\item \textbf{For }every point $x_{i},\ i=1,...,N_{m}$ \textbf{do} Assign
randomly the point $x_{i}$ in a cluster $S_{j}$
