...
Genetic algorithm \cite{genetic1,genetic2} to produce the new features
from the old ones. Furthermore, genetic algorithms have been used
in variety of symmetry problems from the relevant literature \cite{gen_symmetry1,gen_symmetry2,gen_symmetry3}.
