...
then
	METHODPARAMS="--chromosomes=200 --generations=200  --localsearch_method=bfgs --localRate=0.01 --subCluster=1 --subClusterEnable=1 --propagateMethod=NtoN --pNumber=20 --stopRule=doubleBox"
