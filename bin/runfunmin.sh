...
then
	METHODPARAMS="--chromosomes=50 --generations=200  --localsearch_method=bfgs --localRate=0.01 --subCluster=4 --subClusterEnable=1 --propagateMethod=1to1 --pNumber=0 --stopRule=doubleBox"
