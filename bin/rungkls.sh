...
GKLSPARAMS="--gkls_dimension=$DIMENSION --gkls_minima=$MINIMA --gkls_function=$FUNCTION"

./OptimusApp --filename=../PROBLEMS/libgkls.so  --opt_method=$METHOD  $GKLSPARAMS  $METHODPARAMS --iterations=30 --threads=5
