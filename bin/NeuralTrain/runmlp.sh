...
then
	METHODPARAMS="--double_chromosomes=200 --sample_method=uniform --localsearch_method=bfgs --double_localsearchrate=0.01 --double_debug=no --double_generations=500"	
...
then
	METHODPARAMS2="--ipso_particles=100 --ipso_maxgenerations=100 --ipso_localsearch_rate=0.05 --ipso_stoppingrule=best_fitness -ipso_gradientcheck=true --ipso_inertiatype=2"
...
then
	METHODPARAMS2="--population_count=30 --max_generations=100"
fi
